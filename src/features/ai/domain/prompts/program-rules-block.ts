...
6. Comptage (méthodologie des méta-analyses) : une série compte pour CHAQUE muscle dont elle est motrice principale — un développé couché compte pour pectoraux, deltoïdes antérieurs et triceps. Exploite les polyarticulaires pour couvrir le volume de plusieurs muscles à la fois : c'est ce qui permet d'atteindre les planchers sans exploser la durée.
